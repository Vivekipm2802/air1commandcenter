  ...
  const sheets = [
    {
      ...
      downloadUrl:
        "https://drive.google.com/uc?export=download&id=1cxCqiNXtMCf9vgwfScMvUequighPR1Yi",
    },
    {
      ...
      downloadUrl:
        "https://drive.google.com/uc?export=download&id=1VBafb7mZ37voc5Lx3yK80kbo68QcGcCZ",
    },
    {
      ...
      downloadUrl:
        "https://drive.google.com/uc?export=download&id=1lNQxcfTKzYQ2bX3wuCrD1KTghkD7CfmF",
    },
    {
      ...
      downloadUrl:
        "https://drive.google.com/uc?export=download&id=1dU-U44riXDA9TvLnoeMSQnPwKKUHV2j0",
    },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {sheets.map((sheet, i) => (
          ...
          >
            ...
            >
              {React.cloneElement(sheet.icon as React.ReactElement, {
                className: "w-7 h-7",
              })}
            </div>
