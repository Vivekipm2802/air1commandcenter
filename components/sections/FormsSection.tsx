  ...
  return (
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-2xl border border-orange-500/20 text-center">
        <p className="text-[#f9a01b] text-sm font-medium">Want personalized deadline alerts? <button className="underline font-bold ml-1">Connect your calendar</button></p>
      </div>
    </div>
  );
};
